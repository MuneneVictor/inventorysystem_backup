...
$fieldAliases=[
    ...
    'form_factor' => ['form_factor','formfactor','form'],
...
$colStmt=$conn->query("SHOW COLUMNS FROM `iman_hustle_items`");
$availableColumns=[];
...
if($_SERVER['REQUEST_METHOD']==='POST'){
    try{
        ...
        $sql="UPDATE `iman_hustle_items` SET ".implode(', ',$updates)." WHERE id=?";
        $up=$conn->prepare($sql);
        $up->execute($params);
        ...
        try{
            ...
            $details="Updated Iman's Hustle item ".$serialLabel.".";
...
<div class="breadcrumb"><a href="../dashboard/superadmindashboard.php"><i class="fas fa-home"></i> Dashboard</a><span> / </span><a href="overview.php">Iman's Hustle</a><span> / </span><span>Edit Item</span></div>
...
<div class="form-body">
<div class="info-box">
<p><strong>Inventory:</strong> Iman's Hustle</p>
...
<input type="text" name="form_factor" value="<?=safe($view['form_factor']??'')?>">
</div>
