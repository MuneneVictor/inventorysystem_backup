...
if (in_array($role, ['super_admin', 'inventory_admin'])) {
    $stmt = $conn->query("SELECT id, full_name FROM users WHERE role IN ('sales', 'cashier') ORDER BY full_name");
...
<head>
    ...
    <title>Sold RAM/SSD | Mombasa Computers</title>
...
<div class="main-content">
    <div class="page-header">
        <h1><i class="fas fa-memory"></i> Sold RAM / SSD</h1>
    ...
    <div class="search-section">
        ...
        <form method="GET" class="search-grid">
            ...
            <div class="search-actions">
                ...
                <a href="sold_rams_ssds.php" class="btn btn-secondary"><i class="fas fa-undo"></i> Reset</a>
                <?php if (!empty($sales)): ?>
                    <a href="export_sold_rams_ssds_excel.php?<?= http_build_query(array_merge($_GET, ['export' => '1'])) ?>" class="btn btn-excel"><i class="fas fa-file-excel"></i> Export to Excel</a>
                <?php endif; ?>
            </div>
        </form>
    </div>
        ...
        <div class="table-responsive">
            <?php if (empty($sales)): ?>
                <div class="empty-state">
                    ...
                    <p>No sold RAM/SSD found matching your criteria.</p>
                    <a href="sold_rams_ssds.php" class="btn btn-primary" style="margin-top: 1rem;">
