...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-outline { background: transparent; border: 2px solid var(--info); color: var(--info) !important; }
        .btn-outline:hover { background: var(--info); color: white !important; }
    ...
    <div class="header-row">
        <div>
            ...
            <div class="welcome-text">
                <i class="fas fa-hand-wave" style="color: var(--accent);"></i>
    ...
    <div class="section">
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    <?php $i = 1; foreach($topProductsToday as $item): ?>
                        <tr>
                ...
                <tbody>
                    <?php $i = 1; foreach($activeSales as $sale): ?>
                        <tr>
                            ...
                            <td><span class="text-success">KES <?= number_format($sale['total_amount'] ?? 0, 0) ?></span></td>
                            <td><i class="fas fa-user" style="margin-right: 0.25rem; color: var(--gray-400);"></i><?= htmlspecialchars($sale['sold_by_name'] ?? '-') ?></td>
                            <td><?= htmlspecialchars(date('M j, Y H:i', strtotime($sale['created_at'] ?? ''))) ?></td>
                            <td><span class="badge badge-active"><i class="fas fa-circle" style="color: var(--info); font-size: 0.5rem; margin-right: 0.25rem;"></i> Active</span></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
