...
if (empty($model) || $current_price === null) {
...
// Count printers in this group that have this price
...
if (!$sample) {
    die("No printers found matching this group with the current price.");
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!is_numeric($new_price) || $new_price <= 0) {
        ...
        if ($apply_to_all) {
            // Update all printers in this group that have the current price
            $update = $conn->prepare("
                UPDATE printers
                SET price = :new_price
                WHERE model_name = :model
        ...
        // Log activity
        $log = $conn->prepare("INSERT INTO activity_logs (user_id, action, details) VALUES (:uid, 'Updated printer group price', :details)");
        $log->execute([
...
<head>
    ...
    <title>Update Printer Group Price | Mombasa Computers</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <style>
        /* ===== SAME CSS AS update_price_phone_group.php ===== */
        :root {
            --primary: #1a4b2a;
    ...
    <div class="form-container">
        <div class="card">
            <div class="card-header">
                <h2><i class="fas fa-dollar-sign"></i> Update Printer Group Price</h2>
            </div>
            <div class="card-body">
                <?php if ($error): ?>
                ...
                <form method="POST">
                    ...
                    <?php if ($total_count > 1): ?>
                        <div class="info-note">
                            ...
                            <strong>Note:</strong> There are <strong><?= $total_count ?></strong> printers in this group that have this price.
