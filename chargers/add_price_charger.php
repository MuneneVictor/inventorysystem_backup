...
if ($charger['price'] !== null) {
    die("This charger already has a price. Use Update Price instead.");
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!is_numeric($price) || $price <= 0) {
        ...
        $log = $conn->prepare("INSERT INTO activity_logs (user_id, action, details) VALUES (:uid, 'Added charger price', :details)");
        $log->execute([
            'uid' => $_SESSION['user_id'],
            'details' => "Added price for charger ID: $id (Type: {$charger['charger_type']}) to KES $price"
        ]);
...
<head>
    ...
    <title>Add Charger Price | Mombasa Computers</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <style>
        /* Same CSS as smartboard add_price.php */
        :root {
            --primary: #1a4b2a;
    ...
    <div class="form-container">
        <div class="card">
            <div class="card-header">
                <h2><i class="fas fa-dollar-sign"></i> Set Charger Price</h2>
            </div>
            <div class="card-body">
                <?php if ($error): ?>
