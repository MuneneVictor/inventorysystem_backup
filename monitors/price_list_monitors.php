...
// Build SQL query grouping by model_name, size_inches, monitor_condition, price
$sql = "
    SELECT 
        model_name,
        size_inches,
...
if ($filter_condition) {
    $sql .= " AND monitor_condition = :condition";
    $params['condition'] = $filter_condition;
}

$sql .= "
    GROUP BY model_name, size_inches, monitor_condition, price
    ORDER BY model_name, size_inches
";
...
$conditions = ['Ex-Uk', 'New', 'Refurbished'];
?>
...
<head>
    ...
    <title>Monitor Price List | Mombasa Computers</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <style>
        /* ===== SAME CSS AS price_list_smartboards.php ===== */
        :root {
            --primary: #1a4b2a;
...
<div class="main-content">
    ...
    <div class="filter-section">
        <div class="filter-title"><i class="fas fa-filter"></i> Filter Monitors</div>
