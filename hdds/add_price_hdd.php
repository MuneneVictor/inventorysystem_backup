...
if ($hdd['price'] !== null) {
    die("This HDD already has a price. Use Update Price instead.");
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!is_numeric($price) || $price <= 0) {
        ...
        $log = $conn->prepare("INSERT INTO activity_logs (user_id, action, details) VALUES (:uid, 'Added HDD price', :details)");
        $log->execute([
            'uid' => $_SESSION['user_id'],
            'details' => "Added price for HDD ID: $id (Type: {$hdd['type']}, Storage: {$hdd['storage']}) to KES $price"
        ]);
...
<head>
    ...
    <title>Add HDD Price | Mombasa Computers</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <style>
        /* Same CSS as add_price_charger.php – reused */
        :root {
            --primary: #1a4b2a;
...
<div class="main-content">
    <div class="page-header">
        <h1><i class="fas fa-plus-circle"></i> Add HDD Price</h1>
    ...
    <div class="form-container">
        <div class="card">
            <div class="card-header">
                <h2><i class="fas fa-dollar-sign"></i> Set HDD Price</h2>
            </div>
            <div class="card-body">
                <?php if ($error): ?>
