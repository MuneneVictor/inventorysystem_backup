...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!is_numeric($price) || $price <= 0) {
        ...
        if ($apply_to_all) {
            // Update all monitors in this group that have no price
            $update = $conn->prepare("
                UPDATE monitors
                SET price = :price
                WHERE model_name = :model
...
<head>
    ...
    <title>Add Monitor Group Price | Mombasa Computers</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <style>
        /* ===== SAME CSS AS add_price_smartboard_group.php ===== */
        :root {
            --primary: #1a4b2a;
    ...
    <div class="form-container">
        <div class="card">
            <div class="card-header">
                <h2><i class="fas fa-dollar-sign"></i> Set Monitor Group Price</h2>
            </div>
            <div class="card-body">
                <?php if ($error): ?>
                ...
                <form method="POST">
                    ...
                    <?php if ($total_count > 1): ?>
                        <div class="info-note">
                            ...
                            <strong>Note:</strong> There are <strong><?= $total_count ?></strong> monitors in this group that do not have a price.
