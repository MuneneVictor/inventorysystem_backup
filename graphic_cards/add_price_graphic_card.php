...
if ($card['price'] !== null) {
    die("This graphic card already has a price. Use Update Price instead.");
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!is_numeric($price) || $price <= 0) {
        ...
        $log = $conn->prepare("INSERT INTO activity_logs (user_id, action, details) VALUES (:uid, 'Added graphic card price', :details)");
        $log->execute([
            'uid' => $_SESSION['user_id'],
            'details' => "Added price for graphic card ID: $id (Type: {$card['type']}) to KES $price"
        ]);
...
<head>
    ...
    <title>Add Graphic Card Price | Mombasa Computers</title>
...
<div class="main-content">
    <div class="page-header">
        <h1><i class="fas fa-plus-circle"></i> Add Graphic Card Price</h1>
    ...
    <div class="form-container">
        <div class="card">
            <div class="card-header">
                <h2><i class="fas fa-dollar-sign"></i> Set Graphic Card Price</h2>
            </div>
            <div class="card-body">
                <?php if ($error): ?>
                ...
                <form method="POST">
                    <div class="form-group">
                        <label>Price (KES) – per unit</label>
