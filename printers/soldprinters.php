...
$sql = "SELECT p.serial_number, p.model_name, p.branch, p.date_sold, u1.full_name AS added_by, u2.full_name AS sold_by
        FROM printers p
...
<head>
    ...
    <title>Sold Printers | Mombasa Computers</title>
    <link href="https://fonts.googleapis.com/css2?family=Inter:opsz,wght@400;500;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <style>
        /* Same CSS as printers_instock.php */
        :root {
            --primary: #1a4b2a;
...
<div class="main-content">
    ...
    <div class="stats-row">
        <div class="stat-card"><div class="stat-value"><?= count($printers) ?></div><div class="stat-label">Total Sold</div></div>
    ...
    <div class="table-wrapper">
        <div class="table-responsive">
            ...
            <?php else: ?>
                <div class="empty-state"><i class="fas fa-box-open"></i><p>No sold printers found.</p></div>
            <?php endif; ?>
        </div>
    </div>
